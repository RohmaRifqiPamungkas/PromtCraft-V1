...
import { Copy, Download, Play, Check, Sparkles } from "lucide-react"
...
export function PromptPreview({
  prompt, isGenerated, isGenerating, onCopy, onDownload,
}: PromptPreviewProps) {
      ...
      <div className="shrink-0 bg-surface-container-lowest/95 backdrop-blur-sm border-b border-outline-variant px-5 py-3 flex justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          >
            ...
            <span className="hidden lg:inline">Run in AI</span>
          </Button>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-5 lg:p-7">
        <div
          className={cn(
            ...
            isGenerated && "border-primary/20 shadow-primary/5"
          )}
        >
          {/* Editor chrome */}
          ...
          >
            {prompt ? (
              <div className={cn(isGenerated && "animate-fade-in")}>

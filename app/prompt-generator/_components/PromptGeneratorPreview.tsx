...
import {
  Check, Copy, Download, Sparkles, Loader2, History, ArrowLeft,
} from "lucide-react"
      ...
      <div className="shrink-0 bg-surface-container-lowest/95 backdrop-blur-sm border-b border-outline-variant px-5 pt-3 pb-2 flex flex-col gap-2">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <Button
            ...
            className={cn(
              "gap-1.5 text-xs h-7 px-2.5 shrink-0",
        ...
        {/* Row 2: stats + action buttons (hidden in history view) */}
        {!showHistory && (
          <div className="flex items-center justify-between gap-3">
